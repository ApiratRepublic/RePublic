# Logic สำหรับการตรวจมาตรฐาน GDB
V1 (2025-10-29)
...
Featureclass ที่มีชื่อในรูปแบบ "PARCEL_zone_provincecode" เช่น PARCEL_47_50 หรือ PARCEL_48_40 เป็นต้น
### สิ่งที่ตรวจสอบ
...
Featureclass ที่มีชื่อในรูปแบบ "PARCEL_zone_NS3K_provincecode" เช่น  PARCEL_47_NS3K_50 หรือ PARCEL_48_NS3K_40 เป็นต้น
### สิ่งที่ตรวจสอบ
...
Featureclass ที่มีชื่อในรูปแบบ "ROAD_zone" เช่น ROAD_47 หรือ ROAD_48 เป็นต้น
### สิ่งที่ตรวจสอบ
...
Featureclass ที่มีชื่อในรูปแบบ BLOCK FIX_zone เช่น BLOCK_FIX_47 หรือ BLOCK_FIX_48 เป็นต้น
...
Featureclass ที่มีชื่อในรูปแบบ BLOCK_PRICE_zone เช่น BLOCK_PRICE_47 หรือ BLOCK_PRICE_48 เป็นต้น
### สิ่งที่ตรวจสอบ
...
Featureclass ที่มีชื่อในรูปแบบ BLOCK_BLUE_zone ตัวอย่างเช่น BLOCK_BLUE_47 หรือ BLOCK_BLUE_48 เป็นต้น
### สิ่งที่ตรวจสอบ
...
Featureclass ที่มีชื่อในรูปแบบ "PARCEL_REL_zone" เช่น PARCEL_REL_47 หรือ PARCEL_REL_48 เป็นต้น
### สิ่งที่ตรวจสอบ
...
Featureclass ที่มีชื่อในรูปแบบ NS3K_REL_zone เช่น NS3K_REL_47 หรือ NS3K_REL_48 เป็นต้น
### สิ่งที่ตรวจสอบ
...
### Error SUM (รายงานสรุปสิ่งที่ไม่ตรงมาตรฐานแยกตามจีดีบีแฃะประเภทที่พบ)
- **Timestamp**  = วันเวลาที่สร้างรายงาน
- **GDB_Path** = GDB ที่ดำเนินการตรวจสอบ
...
### Report (รายงานสรุปเรื่องไม่ตรงมาตรฐานของแต่ละจังหวัด)
- **Province**  = จังหวัด
